## Do a function that allows the user input n numbers in a list.
## Print lista1 with the entered numbers.
## Print lista2 with the odd numbers of lista1.
## Print lista3 with the even numbers of lista1.
## Print lista4 with the prime numbers of lista1.
## Print lista5 with the elements of lista1 in order.
## Print lista6 with the elements of lista1 in reverse order.
...
def multi_listas():
    try:
        ...
        while n>0:
            n -= 1
            num = float(input("Insira um elemento inteiro: "))
            print("="*75)
            lista1.append(num)
            if primo(num)==True:
                lista4.append(num)
        ...
        print("You've done something wrong. Probably a TypeError?")
    else:
